...
//	http://localhost:port/{your-app-root}/swagger-ui.html
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).consumes(getConsumeContentTypes()).produces(getProduceContentTypes())
					...
					.apis(RequestHandlerSelectors.basePackage("com.ssafy.guestbook.controller")) ////controller 안에서 
					.paths(postPaths()).build()                   								//// admin/* 모든것
	...
	private Set<String> getConsumeContentTypes() {
        ...
        consumes.add("application/json;charset=UTF-8");                 //들어오는 데이터
    ...
    private Set<String> getProduceContentTypes() {
        ...
        produces.add("application/json;charset=UTF-8");   ///여기서 실행한다음 보내주는 데이터
        return produces;
    }
...
//		return or(regex("/admin/.*"), regex("/user/.*"));
		return regex("/admin/.*");  ///////////////////////////주소가 admin / 모든 것
	}
