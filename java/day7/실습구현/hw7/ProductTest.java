...
// 			product = new Product(num,name,price,stock,info); //입력받은걸로 객체 생성
			...
			pmgr.add(new Refrigerator(23455,"삼성냉장고1",1800000,4,"큰타입",400,"blue"));
			pmgr.add(new Refrigerator(27755,"삼성냉장고3",870000,5,"가성비굿",300,"yellow"));
			pmgr.add(new Product(23125,"샘성에어컨",255000,1,"엄청시원")); 
			pmgr.add(new TV(7635,"삼성TV1번",1500000,7,"HD",50));
			pmgr.add(new Refrigerator(8876,"삼성냉장고2",1200000,2,"제일시원",500,"green"));
			...
			pmgr.add(new TV(55555,"삼성TV4번",1270000,12,"HD",55));
...
//		num2 = Integer.parseInt(br.readLine());
		...
		System.out.println("****************************");
		System.out.println("400L 이상의 냉장고만 검색");
		...
		System.out.println("****************************");
		System.out.println("50inch이상의 TV만 검색");
